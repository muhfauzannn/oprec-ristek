...
const Navbar = () => {
  ...
  return (
    <div className="z-50 font-geist h-fit fixed py-7 max-lg:py-6 max-md:py-5 max-sm:py-4 px-20 max-lg:px-14 max-md:px-12 max-sm:px-6 w-full flex justify-between items-center shadow-lg">
